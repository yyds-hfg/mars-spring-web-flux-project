package com.hacker.mars.generate;
...
public class MybatisGenerateCode {
    ...
    public static final String PACKAGE_ATH = "com.hacker.mars.infrastructure.persistent";

    public static final String JDBC = "jdbc:mysql://localhost:3306/java-framework?serverTimezone=GMT%2B8";

    public static String projectPath = "E:\\java-framework\\BaiduSyncdisk\\github\\Java-Framework-Labs\\lab01-springboot-mybatis";

    public static String[] tableName = new String[]{
            "mybatis_orders",
            "mybatis_sys_role",
            "mybatis_sys_user_role",
            "mybatis_user"
    };
    ...
    private static void extracted1() {
         ...
         * 全局配置
         */
        String filePath = System.getProperty("user.dir") + "/src/main/java";  //java下的文件路径
        ...
        PackageConfig packages = new PackageConfig.Builder()
                .entity("po")//实体类包名
                .parent(PACKAGE_ATH)//父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
                ...
                .pathInfo(Collections.singletonMap(OutputFile.mapperXml, System.getProperty("user.dir") + "/src/main/resources/mapper/mapper")) //路径配置信息,就是配置各个文件模板的路径信息,这里以mapper.xml为例
                .build();
        /**
         * 模板配置
         */
...
//                .disable(TemplateType.ENTITY)//禁用指定模板
                ...
                .controller("")//controller层模板路径
                .build();
        System.out.println(template.getEntity(false));
...
//            .build();
        ...
        StrategyConfig strategyConfig = new StrategyConfig.Builder()
                ...
                .formatFileName("%sPo")//格式化实体名称，%s取消首字母I
...
//                .injection(injectionConfig)
    ...
    private static AutoGenerator getAutoGenerator() {
        ...
        DataSourceConfig dsc = new DataSourceConfig.Builder(JDBC,
                "root", "123456")
...
//                .fileOverride()//覆盖生成文件
        ...
        PackageConfig packages = new PackageConfig.Builder()
                ...
                .controller("controller")//控制层包名
                .mapper("mapper")//mapper层包名
                .xml("editMapper")//数据访问层xml包名
                .service("service")//service层包名
                .serviceImpl("service.impl")//service实现类包名
                .other("output")//输出自定义文件时的包名
                .pathInfo(Collections.singletonMap(OutputFile.mapperXml, System.getProperty("user.dir") + "/src/main/resources/mapper/editMapper")) //路径配置信息,就是配置各个文件模板的路径信息,这里以mapper.xml为例
                .build();
        /**
         * 模板配置
         */
...
//                .disable(TemplateType.ENTITY)//禁用指定模板
                ...
                .serviceImpl("")//实现类模板路径
//                .mapper("")//mapper模板路径
                .mapperXml("/templates/editMapper.xml.vm")//xml文件模板路路径
                .controller("")//controller层模板路径
                .build();
        System.out.println(template.getEntity(false));
        ...
        StrategyConfig strategyConfig = new StrategyConfig.Builder()
                ...
                //.cache(缓存类.class)设置缓存实现类
                .formatMapperFileName("%sMapper")//格式化Dao类名称
                .formatXmlFileName("%sEditMapper")//格式化xml文件名称
                .build()
